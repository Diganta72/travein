...
function addReservationToTable(reservations) {
  ...
  if (reservations.length >= 0) {
    ...
    reservations.map((reservation) => {
      ...
      let convertedDate = new Date(reservation.time).toLocaleDateString("en-IN");
      let convertedTime = new Date(reservation.date).toLocaleString("en-IN", {
        year: "numeric",
        day: "numeric",
        month: "long",
        hour: "numeric",
      ...
      tRow.innerHTML = `
        <a href = "../detail/?adventure=${reservation.adventure}"<td>${reservation.id}</a>
        </td>
        ...
        <td>
         ...
         <a href = "../detail/?adventure=${reservation.adventure}">Visit Adventure</button></a>
        </td>
    `;
